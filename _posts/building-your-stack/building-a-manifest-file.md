...
Each application type support the additional partial configuration to add custom live log files for that application type. An example of this is:
...
For more examples and information, see the [LiveLogs help page](http://help.cloud66.com/managing-your-stack/live-logs)
