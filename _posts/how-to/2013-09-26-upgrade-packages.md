...
<div class="notice notice-danger">
    <h3>Warning!</h3>
    <p>If you are upgrading your ruby base version then you should put your stack in maintenance mode first. Passenger based stacks will have some down-time during the upgrade</p>
</div>
