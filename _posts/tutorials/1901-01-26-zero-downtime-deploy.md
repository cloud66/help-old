...
Using a web server like <a href="http://help.cloud66.com/web-server/unicorn-rack-server.html">Unicorn</a> or <a href="http://help.cloud66.com/web-server/passenger-enterprise.html">Passenger Enterprise</a> would allow you to achieve zero-downtime deployments even with a single application server.
...
When you have a load balancer in front of your application servers, you can choose to <a href="http://help.cloud66.com/deployment/parallel-deployment.html">deploy in serial</a>. This would involve removing one server at a time from the load balancer, deploying your code to it and then re-adding it to the load balancer.
<br/><br/>
